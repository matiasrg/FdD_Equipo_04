...
### Aporte para EcoAlerta
Esta norma provee la base científica que respalda el procesamiento de datos realizado en el software embebido del microcontrolador (sección "Software — dispositivo electrónico" de la Lista de Exigencias). Es el eslabón técnico entre "el sensor mide radiación" y "la app muestra un número del 1 al 11+": sin esta función de ponderación, no habría una forma estandarizada y reproducible de convertir la lectura física del sensor en el índice que pide la Lista de Exigencias.
