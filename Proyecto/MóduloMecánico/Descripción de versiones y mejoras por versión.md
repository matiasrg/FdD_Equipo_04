...
* **Ajuste para conector de chasis y switch:** Modificación de las aberturas del panel frontal para asegurar el calce perfecto de un conector de alimentación USB Tipo-C de empotrar y un interruptor general (switch) basculante.
